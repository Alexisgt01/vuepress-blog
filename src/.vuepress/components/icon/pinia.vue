...
<template>
 <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" >
            <title>Pinia</title>
            <g fill="none" fill-rule="evenodd" transform="matrix(0.048092, 0, 0, 0.048092, 2.12692, -0.094354)">
                ...
                <path
                  ...
                  style="fill: rgb(255, 229, 108);"
                ></path>
                <ellipse cx="260.5" cy="335" fill="#eaadcc" rx="21.5" ry="10"></ellipse>
                <ellipse
                  cx="102.5" cy="329" fill="#eaadcc" rx="21.5" ry="10"
                ...
                <g transform="matrix(-.99939083 .0348995 .0348995 .99939083 269.284825 271.027667)">
                    ...
                    <g fill="#fff">
                        ...
                        <path
                          ...
                          fill-rule="nonzero" stroke="#fff" stroke-width="3"
                        ></path>
                        <path d="m24 31c0-3.865549 3.134451-7 7-7s7 3.134451 7 7-3.134451 7-7 7-7-3.134451-7-7z"></path>
                    </g>
                </g>
                <g stroke-linecap="round" stroke-width="11">
                    <g stroke="#ecb732">
                        <path d="m70.5 377.5 74 77"></path>
                        <path d="m134.5 386.5-47 50"></path>
                    </g>
                    <g stroke="#ecb732" transform="matrix(-1 0 0 1 298 377)">
                        <path d="m.5.5 74 77"></path>
                        <path d="m64.5 9.5-47 50"></path>
                    </g>
                    <g stroke="#ffc73b" transform="matrix(0 1 -1 0 215 207)">
                        <path d="m.5.5 49 49"></path>
                        <path d="m.5 10.5 49 49" transform="matrix(-1 0 0 1 50 0)"></path>
                    </g>
                </g>
            </g>
        </svg>
